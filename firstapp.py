                        ...
                        if st.checkbox("Area Chart"):
                            ...
                            if st.checkbox("Interpret"):            
                                    if model_choice == "KNN":
                                        ...
                                        df = pd.read_csv("data/diabetesdata.csv")
                                        x = df[['Age', 'Gender', 'Polyuria', 'Polydipsia', 'Sudden weight loss', 'Weakness', 'Polyphagia', 'Genital_thrush', 'visual_blurring','Itching', 'Irritability', 'delayed healing', 'partial paresis','muscle stiffness', 'Alopecia', 'Obesity']]
                                        feature_names = ['Age', 'Gender', 'Polyuria', 'Polydipsia', 'sudden weight loss', 'weakness', 'Polyphagia', 'Genital thrush', 'Visual blurring','Itching', 'Irritability', 'Delayed_healing', 'Partial_paresis','Muscle_stiffness', 'Alopecia', 'Obesity']
